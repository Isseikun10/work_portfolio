    ...
    return (
        <div className="fixed top-0 left-0 w-full bg-opacity-70 backdrop-blur-md z-50">
            <div className="max-w-[1300px] mx-auto flex justify-between text-gray-200 text-xl items-center px-12 h-20">
                <a href="#">Edwin Bonilla Dolores</a>

                <ul className="hidden md:flex gap-12 z-10 cursor-pointer">
                    <li> <Link to="skills" smooth={true} offset={50} duration={500}> Acerca de </Link> </li>
                    <li> <Link to="portfolio" smooth={true} offset={50} duration={500}> Portafolio </Link> </li>
                    <li> <Link to="courses" smooth={true} offset={50} duration={500}> Cursos y Certificados </Link> </li>
                    <li> <Link to="contact" smooth={true} offset={50} duration={500}> Contacto </Link> </li>
                </ul>

                <div onClick={tooggleNav} className="md:hidden z-50 text-gray-200">
                ...
                <motion.div initial={false} animate={nav ? "open" : "closed"} variants={menuVariants} className="fixed left-0 top-0 w-full min-h-screen bg-gray-900 z-40">
                    <ul className="font-semibold text-4xl space-y-8 mt-24 text-center ">
                        <li> <Link to="skills" onClick={closeNav} smooth={true} offset={50} duration={500}> Acerca de </Link> </li>
                        <li> <Link to="portfolio" onClick={closeNav} smooth={true} offset={50} duration={500}> Portafolio </Link> </li>
                        <li> <Link to="courses" onClick={closeNav} smooth={true} offset={50} duration={500}> Cursos y Certificados </Link> </li>
